...
import { WalletError, BaseMessageSignerWalletAdapter, WalletReadyState, WalletPublicKeyError, WalletNotConnectedError, WalletNotReadyError, WalletConnectionError, WalletDisconnectedError, WalletSignTransactionError, WalletSendTransactionError, WalletSignMessageError, BaseWalletAdapter, WalletAccountError, WalletDisconnectionError, WalletConfigError } from "@solana/wallet-adapter-base";
import { watch, watchEffect, ref, computed, shallowRef, defineComponent, toRefs, openBlock, createElementBlock, createCommentVNode, resolveComponent, renderSlot, normalizeProps, guardReactiveProps, createElementVNode, createBlock, toDisplayString, nextTick, Fragment, normalizeClass, Teleport, withModifiers, renderList, createVNode, createTextVNode, withCtx, normalizeStyle } from "vue";
import { VersionedMessage, Transaction, VersionedTransaction, SIGNATURE_LENGTH_IN_BYTES as SIGNATURE_LENGTH_IN_BYTES$1, PublicKey } from "@solana/web3.js";
...
function useWalletState(wallets2, name) {
  ...
  const refreshWalletState = () => {
    ...
    readyState.value = (_f = (_e = wallet.value) == null ? void 0 : _e.readyState) != null ? _f : WalletReadyState.Unsupported;
  };
  watchEffect(() => {
    var _a;
